      ...
      <DialogContent className="sm:max-w-[500px] bg-zinc-900 border-white/10 text-white">
        ...
        <form action={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <Label htmlFor="quantity" className="text-zinc-400">Menge *</Label>
              <Input
                id="quantity"
                name="quantity"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="unit" className="text-zinc-400">Einheit *</Label>
              <select
                id="unit"
                name="unit"
          ...
          <div className="space-y-2">
            <Label htmlFor="location" className="text-zinc-400">Lagerort</Label>
            <select
              id="location"
              name="location"
              className="w-full px-3 py-2 border border-white/10 text-white bg-zinc-950 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-white/20"
          ...
          <div className="space-y-2">
            <Label htmlFor="icon" className="text-zinc-400">Icon</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="expiryDate" className="text-zinc-400">Ablaufdatum (optional)</Label>
            <Input
              id="expiryDate"
              name="expiryDate"
              type="date"
          ...
          <div className="space-y-2">
            <Label htmlFor="lowStockThreshold" className="text-zinc-400">Warnschwelle (optional)</Label>
            <Input
              ...
              className="bg-zinc-950 border-white/10 text-white placeholder:text-zinc-600 focus-visible:ring-white/20"
            />
            <p className="text-xs text-zinc-500">Warnung, wenn Menge unter diesen Wert fällt</p>
          </div>
